        ...
        return (
            <div className="card mb-3">
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">Today we will set up Authentication with Google Firebase. You can find the documentation <a href='https://firebase.google.com/docs/auth/web/start?authuser=0' target="_blank">here</a></p>
                </div>
            </div>
        )
    }
